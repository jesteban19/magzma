...
add_action( 'tgmpa_register', 'magzma_register_required_plugins' );
 ...
 */
function magzma_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'     				=> esc_html__( 'Contact Form 7', 'magzma' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Redux Framework', 'magzma' ), // The plugin name
		...
		array(
			'name'     				=> esc_html__( 'Elementor', 'magzma' ), // The plugin name
