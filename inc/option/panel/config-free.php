        ...
        public function setSections() {
            ...
            // DECLARATION OF SECTIONS
                ...
                $this->sections[] = array(
                    ...
                    'desc'       => __( 'Upgrade your theme here to get more options and features: ', 'magzma' ) . '<a href="' . mag_fs()->get_upgrade_url() . '" target="_blank">UPGRADE NOW!</a>',
