<?php
	...
	$fs_text = array(
		...
		'delete-account-confirm'                   => __( 'Deletion is not temporary. Only delete if you no longer want to use this %s anymore. Are you sure you would like to continue with the deletion?', 'freemius' ),
		...
		'after-downgrade-non-blocking'             => __( 'You can still enjoy all %s features but you will not have access to %s updates and support.', 'freemius' ),
		...
		'deactivation-share-reason'                => __( 'If you have a moment, please let us know why you are %s', 'freemius' ),
		'deactivating'                             => __( 'deactivating', 'freemius' ),
		'deactivation'                             => __( 'Deactivation', 'freemius' ),
		'theme-switch'                             => __( 'Theme Switch', 'freemius' ),
		'switching'                                => __( 'switching', 'freemius' ),
		'switch'                                   => __( 'Switch', 'freemius' ),
		'activate-x'                               => __( 'Activate %s', 'freemius' ),
		'deactivation-modal-button-confirm'        => __( 'Yes - %s', 'freemius' ),
		'deactivation-modal-button-submit'         => __( 'Submit & %s', 'freemius' ),
		'deactivation-modal-button-cancel'         => __( 'Cancel', 'freemius' ),
		'reason-no-longer-needed'                  => __( 'I no longer need the %s', 'freemius' ),
		'reason-found-a-better-plugin'             => __( 'I found a better %s', 'freemius' ),
		'reason-needed-for-a-short-period'         => __( 'I only needed the %s for a short period', 'freemius' ),
		'reason-broke-my-site'                     => __( 'The %s broke my site', 'freemius' ),
		'reason-suddenly-stopped-working'          => __( 'The %s suddenly stopped working', 'freemius' ),
		...
		'reason-temporary-x'                       => __( "It's a temporary %s. I'm just debugging an issue.", 'freemius' ),
		'reason-other'                             => _x( 'Other', 'the text of the "other" reason for deactivating the %s that is shown in the modal box.', 'freemius' ),
		'ask-for-reason-message'                   => __( 'Kindly tell us the reason so we can improve.', 'freemius' ),
		'placeholder-plugin-name'                  => __( "What's the %s's name?", 'freemius' ),
		...
		'reason-great-but-need-specific-feature'   => __( "The %s is great, but I need specific feature that you don't support", 'freemius' ),
		'reason-not-working'                       => __( 'The %s is not working', 'freemius' ),
		'reason-not-what-i-was-looking-for'        => __( "It's not what I was looking for", 'freemius' ),
		'reason-didnt-work-as-expected'            => __( "The %s didn't work as expected", 'freemius' ),
		...
		'reason-didnt-work'                        => __( "The %s didn't work", 'freemius' ),
		...
		'license-sync-disclaimer'                  => __( 'The %s will be periodically sending data to %s to check for %s updates and verify the validity of your license.', 'freemius' ),
		...
		'permissions-events'                       => __( 'Current %s Events', 'freemius' ),
		...
		'user-exist-message_ownership'             => __( 'If you would like to give up the ownership of the %s\'s account to %s click the Change Ownership button.', 'freemius' ),
		...
		'premium-activated-message'                => __( 'Premium %s version was successfully activated.', 'freemius' ),
		...
		'license-expired-blocking-message'         => __( 'Your license has expired. You can still continue using the free %s forever.', 'freemius' ),
		...
		'in-trial-mode'                            => __( 'You are already running the %s in a trial mode.', 'freemius' ),
		...
		'no-trials'                                => __( 'None of the %s\'s plans supports a trial period.', 'freemius' ),
		'unexpected-api-error'                     => __( 'Unexpected API error. Please contact the %s\'s author with the following error.', 'freemius' ),
		...
		'squid-sysadmin-desc'                      => __( 'Great, please whitelist the following domains: %s. Once you are done, deactivate the %s and activate it again.', 'freemius' ),
		...
		'curl-missing-sysadmin-desc'               => __( 'Great, please install cURL and enable it in your php.ini file. To make sure it was successfully activated, use \'phpinfo()\'. Once activated, deactivate the %s and reactivate it back again.', 'freemius' ),
